...
df_ucalg = pd.read_excel('C:/Users/bav/OneDrive - Geological survey of Denmark and Greenland/Data/Dye-2/Samimi 2016 Dye-2/AWS_Samimi_Marshall_Dye2_Summer2016.xlsx',skiprows=5)
df_ucalg.columns = ['time', 'decimal day', 'record','Battery', 'logger T', 'airT', 'RH', 'Pressure', 'SW in', 'SW out', 'CNR1TK', 'LW in', 'LW out', 'windspd', 'winddir', 'std winddir']
