...
# 4 GITS
## Removing erroneous data at GITS
Flagging data:
...
# 5 Humboldt
## Removing erroneous data at Humboldt
No erroneous data listed for Humboldt
## Adjusting data at Humboldt
# 6 Summit
## Removing erroneous data at Summit
Flagging data:
Warning: interpreting AirPressurehPa as P
|start time|end time|variable|
|-|-|-|
...
# 7 Tunu-N
## Removing erroneous data at Tunu-N
...
# 15 NASA-SE
## Removing erroneous data at NASA-SE
