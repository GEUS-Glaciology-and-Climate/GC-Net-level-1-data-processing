...
def nameLevel0col(dfm):
    ...
    variable_aliases = {"sw_in_avg(1)": "ISWR", "sw_in_avg": "ISWR",
                        "sw_ref_avg(1)": "OSWR", "sw_ref_avg": "OSWR",
                        "net_rad_avg": "NSWR", "t_air_avg(1)": "TA3",
                        "t_air_avg(2)": "TA4", "t_air1_avg": "TA3",
                        "t_air2_avg": "TA4", "tc_air_avg(1)": "TA1",
                        "tc_air_avg": "TA1", "tc_air_avg(2)": "TA2",
                        "rh_avg(1)": "RH1", "rh_avg(2)": "RH2",
                        "u_avg(1)": "VW1", "u_avg(2)": "VW2",
                        "dir_avg(1)": "DW1", "dir_avg(2)": "DW2",
                        "dir1_avg": "DW1", "dir2_avg": "DW2",
                        "pressure_avg": "P", "sd_1_avg": "HW1",
                        "sd_2_avg": "HW2", "tc_air_max": "TA1_max",
                        "tc_air_min": "TA1_min", "u_max(1)": "VW1_max",
                        "u_max(2)": "VW2_max", "u_std(1)": "VW1_stdev",
                        "u_std(2)": "VW2_stdev", "sw_in_max(1)": "ISWR_max",
                        "sw_in_max": "ISWR_max",  "sw_in_std(1)": "ISWR_std",
                        "sw_in_std": "ISWR_std", "net_rad_std": "NSWR_std",
    ...
    if len(ind)>0:
        print('====> Warning:', dfm.columns[~ind], 'are in the L0 data file but not in the dataframe')
